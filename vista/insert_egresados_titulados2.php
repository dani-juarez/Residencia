...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($programa) && !empty($modalidad) && !empty($hombres_egresados) && !empty($mujeres_egresados) && !empty($hombres_titulados) && !empty($mujeres_titulados) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO egresados_titulados2(programa,modalidad,hombres_egresados,mujeres_egresados,hombres_titulados,mujeres_titulados) VALUES(:programa,:modalidad,:hombres_egresados,:mujeres_egresados,:hombres_titulados,:mujeres_titulados)');
