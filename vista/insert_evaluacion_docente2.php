...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($programa) && !empty($modalidad) && !empty($calif_promedio) && !empty($total_docentes) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO evaluacion_docente2(programa,modalidad,calif_promedio,total_docentes) VALUES(:programa,:modalidad,:calif_promedio,:total_docentes)');
