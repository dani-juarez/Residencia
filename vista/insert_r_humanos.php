...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($prof_tiempo_completo) && !empty($licenciatura) && !empty($especialidad) && !empty($maestria) && !empty($maestria_s_a) && !empty($doctorado) && !empty($doctorado_s_a) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO r_humanos(prof_tiempo_completo,licenciatura,especialidad,maestria,maestria_s_a,doctorado,doctorado_s_a) VALUES(:prof_tiempo_completo,:licenciatura,:especialidad,:maestria,:maestria_s_a,:doctorado,:doctorado_s_a)');
...
<body>
	<div class="contenedor">
		<h2>NUEVO PROFESOR DE TIEMPO COMPLETO</h2>
		<form action="" method="post">
			<div class="form-group">
				<input type="text" name="prof_tiempo_completo" placeholder="PROFESOR DE TIEMPO COMPLETO" class="input__text">
