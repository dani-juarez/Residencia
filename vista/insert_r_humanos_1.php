...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($prof_trescuartos_tiempo) && !empty($licenciatura) && !empty($especialidad) && !empty($maestria) && !empty($maestria_s_a) && !empty($doctorado) && !empty($doctorado_s_a) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO r_humanos_1(prof_trescuartos_tiempo,licenciatura,especialidad,maestria,maestria_s_a,doctorado,doctorado_s_a) VALUES(:prof_trescuartos_tiempo,:licenciatura,:especialidad,:maestria,:maestria_s_a,:doctorado,:doctorado_s_a)');
...
<body>
	<div class="contenedor">
		<h2>NUEVO PROFESOR DE 3/4 DE TIEMPO</h2>
		<form action="" method="post">
			<div class="form-group">
				<input type="text" name="prof_trescuartos_tiempo" placeholder="PROFESOR DE 3/4 DE TIEMPO" class="input__text">
