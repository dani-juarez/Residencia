...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($docentes) && !empty($hombres) && !empty($mujeres) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO r_humanos_docentes(docentes,hombres,mujeres) VALUES(:docentes,:hombres,:mujeres)');
	...
	<div class="contenedor">
		...
		<form action="" method="post">
			<div class="form-group">
				<input type="text" name="docentes" placeholder="DOCENTE" class="input__text">
			</div>
			<div class="form-group">
