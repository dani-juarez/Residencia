...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($funcionarios) && !empty($hombres) && !empty($mujeres) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO r_humanos_funcionarios(funcionarios,hombres,mujeres) VALUES(:funcionarios,:hombres,:mujeres)');
...
<body>
	<div class="contenedor">
		<h2>NUEVO FUNCIONARIO DOCENTE</h2>
		<form action="" method="post">
			<div class="form-group">
				<input type="text" name="funcionarios" placeholder="FUNCIONARIO DOCENTE" class="input__text">
			</div>
			<div class="form-group">
