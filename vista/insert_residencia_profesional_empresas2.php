...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($empresas) && !empty($nombre_proyecto) && !empty($creacion) && !empty($hombres_total) && !empty($mujeres_total) && !empty($total) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO residencia_profesional_empresas2(empresas,nombre_proyecto,creacion,hombres_total,mujeres_total,total) VALUES(:empresas,:nombre_proyecto,:creacion,:hombres_total,:mujeres_total,:total)');
