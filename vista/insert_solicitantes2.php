...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($programa) && !empty($modalidad) && !empty($capacidad_instalada) && !empty($hombres_solicitantes) && !empty($mujeres_solicitantes) && !empty($hombres_aceptados) && !empty($hombres_aceptados) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO solicitantes2(programa,modalidad,capacidad_instalada,hombres_solicitantes,mujeres_solicitantes,hombres_aceptados,mujeres_aceptados) VALUES(:programa,:modalidad,:capacidad_instalada,:hombres_solicitantes,:mujeres_solicitantes,:hombres_aceptados,:mujeres_aceptados)');
