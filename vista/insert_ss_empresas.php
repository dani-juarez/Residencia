...
<?php 
	...
	if(isset($_POST['guardar'])){
		...
		if(!empty($empresas) && !empty($hombres) && !empty($mujeres) && !empty($hombres_total) && !empty($mujeres_total) && !empty($total) ){
				...
				$consulta_insert=$con->prepare('INSERT INTO servicio_social_empresas(empresas,hombres,mujeres,hombres_total,mujeres_total,total) VALUES(:empresas,:hombres,:mujeres,:hombres_total,:mujeres_total,:total)');
